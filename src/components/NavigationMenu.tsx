    ...
    <NavigationMenu className="">
      <NavigationMenuList className="">
        <NavigationMenuItem className="bg">
          ...
          <NavigationMenuContent className="bg-slate-900 text-white">
            <ul className="flex flex-col gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <ListItem href="/" title="Advanced Analytics">
                Powerful Analytics for Your Links
              </ListItem>
              <ListItem href="/" title="Branded Links">
                Branded Links for Your Brand
              </ListItem>
              <ListItem href="/" title="QR Codes">
                Beautiful QR Codes for Your Links
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
